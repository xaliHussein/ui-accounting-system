<template>
  <v-container fluid>
    <v-row>
              ...
              <v-row>
                ...
                <v-col cols="12" sm="12" md="12" lg="12" class="text-center">
                  <v-btn
                    color="#16213E"
                    outlined
                    @click="pop_variations"
                    class="px-10 ml-3"
                  >
                    <h3 style="color: #16213e">تفاصيل المنتج</h3>
                  ...
                  <v-btn
                    ...
                    class="px-10"
                  >
                    <h3 style="color: white">شراء منتج</h3>
                    <template v-slot:loader>
                      <span class="custom-loader">
                        <v-icon color="white">mdi-cached</v-icon>
                      </span>
      ...
      />
      <PopGoodsVariations
        :value="popGoodsVariations"
        v-on:popGoodsVariations="popGoodsVariations = !popGoodsVariations"
      />
      <!-- end -->
    </v-row>
  </v-container>
...
import PopGoodsVariations from "../components/Buy/PopGoodsVariations.vue";
import AppPopDelete from "../components/Buy/AppPopDelete.vue";
export default {
  components: { Input, AppPopEdit, AppPopDelete, PopGoodsVariations },
  name: "AppBuy",
  data() {
    return {
      valid: false,
  ...
  methods: {
    ...
    pop_variations() {
      this.popGoodsVariations = !this.popGoodsVariations;
    },
  },
  watch: {
    pagination: {
